...
def-env activate-virtualenv [] {
    ...
    let virtual_env = '/home/4600-1238@mydoc.mfc-kursk.ru/Python/project_dir/venv'
    let bin = 'bin'
    let path_sep = ':'
...
alias deactivate = source '/home/4600-1238@mydoc.mfc-kursk.ru/Python/project_dir/venv/bin/deactivate.nu'
